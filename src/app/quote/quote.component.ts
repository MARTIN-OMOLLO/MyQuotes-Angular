...
export class QuoteComponent implements OnInit {
  quotes:Quotes[] = [
    ...
    new Quotes (3, 'Lawrence', 'Motivational', 'The greatest glory in living lies not in never falling but in rising every time we fail','Maya Angelou',new Date(2021,3,1), 0, 0)
